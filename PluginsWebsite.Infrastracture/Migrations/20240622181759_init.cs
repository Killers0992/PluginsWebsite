        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Loaders_Authors_AuthorId",
                        column: x => x.AuthorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Plugins_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryLinks_Plugins_PluginId",
                        column: x => x.PluginId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Files_GameVersions_GameVersionId",
                        column: x => x.GameVersionId,
                        principalTable: "GameVersions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Files_Plugins_PluginId",
                        column: x => x.PluginId,
                        principalTable: "Plugins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Hash = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LoaderId = table.Column<int>(type: "int", nullable: false),
                    FileId = table.Column<int>(type: "int", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoaderFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LoaderFiles_Files_FileId",
                        column: x => x.FileId,
                        principalTable: "Files",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LoaderFiles_Loaders_LoaderId",
                        column: x => x.LoaderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssemblyName = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AssemblyVersion = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LoaderId = table.Column<int>(type: "int", nullable: true),
                    PluginId = table.Column<int>(type: "int", nullable: true),
                    NugetId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Dependencies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Dependencies_LoaderFiles_FileId",
                        column: x => x.FileId,
                        principalTable: "LoaderFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Dependencies_Loaders_LoaderId",
                        column: x => x.LoaderId,
                        principalTable: "Loaders",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Dependencies_Nugets_NugetId",
                        column: x => x.NugetId,
                        principalTable: "Nugets",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Dependencies_Plugins_PluginId",
                        column: x => x.PluginId,
                        principalTable: "Plugins",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryLinks_PluginId",
                table: "CategoryLinks",
                column: "PluginId");

            migrationBuilder.CreateIndex(
                name: "IX_Dependencies_FileId",
                table: "Dependencies",
                column: "FileId");

            migrationBuilder.CreateIndex(
                name: "IX_Dependencies_LoaderId",
                table: "Dependencies",
                column: "LoaderId");

            migrationBuilder.CreateIndex(
                name: "IX_Dependencies_NugetId",
                table: "Dependencies",
                column: "NugetId");

            migrationBuilder.CreateIndex(
                name: "IX_Dependencies_PluginId",
                table: "Dependencies",
                column: "PluginId");

            migrationBuilder.CreateIndex(
                name: "IX_Files_GameVersionId",
                table: "Files",
                column: "GameVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_Files_PluginId",
                table: "Files",
                column: "PluginId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoaderFiles_FileId",
                table: "LoaderFiles",
                column: "FileId");

            migrationBuilder.CreateIndex(
                name: "IX_LoaderFiles_LoaderId",
                table: "LoaderFiles",
                column: "LoaderId");

            migrationBuilder.CreateIndex(
                name: "IX_Loaders_AuthorId",
                table: "Loaders",
                column: "AuthorId");
